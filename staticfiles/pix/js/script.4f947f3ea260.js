...
const userIcon = document.getElementById("user-icon");
    ...
    userIcon.addEventListener("mouseover", function() {
      this.style.backgroundColor = "lightblue"; // Change to light blue on hover
    });

    userIcon.addEventListener("mouseout", function() {
      this.style.backgroundColor = "white"; // Reset to white on mouseout
    });
...
const dropdowncontainer = document.getElementById("dropdown-container");
	...
	document.addEventListener('click', function(event) {
		...
		const isOpenDropdown = document.querySelector('.dropdown-content.show');
		if (!isDropdownBtn && isOpenDropdown) {
		  isOpenDropdown.classList.remove('show');
		}
	  });
